...
In this Chapter, I probe the resonant gravitational interactions between a central binary modeled after Kepler-38 and an external gaseous circumbinary protoplanetary disk. I found that these interactions occur at the 1:3 eccentric outer Lindblad resonance (EOLR) for two separate regimes, depending on the binary eccentricity. I demonstrate that binaries with eccentric orbits strongly couple to the disk, launching an $m=1$ spiral density wave within the disk and exciting eccentricity growth for both the binary orbit and the inner edge of the disk where planets form and migrate. Binaries on nearly circular orbits, on the other hand, weakly couple to the disk and only drive eccentricity growth for gas near the inner edge of the disk. I explore how this evolutionary varies as a function of disk parameters. I conclude this Chapter by considering the long-term consequences of this evolution for the binary orbit and for planet formation within a circumbinary disk.
...
I study the sensitivity of my results on disk resolution and aspect ratio in Simulations 9, 10, and 11 with discussion in Section 
...
Section \ref{CBDisk:sec:discEccEvolution}, I applied the secular theory of
...
\ref{CBDisk:sec:methods_section}.  To relate $\alpha_{eff}$ and $\alpha_{SPH}$, I use the following relation from \citet{Lodato2010} and \citet{Meru2012}
...
To study how my results vary with disk mass, three additional simulations were run with $e_{bin} =
