...
In this Chapter, I build a probabilistic model for TRAPPIST-1's long-term X-ray and ultraviolet (XUV) luminosity evolution conditioned on observations of TRAPPIST-1 and their uncertainties. I demonstrate that TRAPPIST-1 likely maintained high $L_{XUV}/L_{bol} \approx 10^{-3}$ throughout its lifetime and could still be in the saturated emission phase today. Given these constraints, I then consider the evolving XUV radiation environment experienced by its planetary system and examine the implications. I explain how my modeling is too computationally-expensive to scale to additional systems or more complex models, motivating the use of novel machine learning methods to reduce the computational cost. I apply the open-source Python machine learning package introduced in Chapter 5, \approxposterior, to this problem. I then demonstrate how novel machine learning methods can accurately replicate my inference, but requires nearly three orders of magnitude fewer computational resources.
